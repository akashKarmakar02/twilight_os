...
use crate::sys::memory::paging::{FrameAllocator, Mapper, OffsetPageTable, Page, PageTable, PageTableFlags, Size4KiB, Translate, PhysFrame, active_level_4_table, FRAME_ALLOCATOR};
use crate::sys::memory::paging::{PhysAddr, VirtAddr};
...
pub(crate) static mut PHYSICAL_MEMORY_OFFSET: VirtAddr = VirtAddr::zero();
